...
\uncover<8->{rup >= 1 ;}
        ...
        \onslide<9->{Only a \deadend{} needs justifying: one line saying those decisions cannot
        all hold. The proof is the tree, rotated a quarter turn.}
        \onslide<10->{No propagator said a word, and \toolname{VeriPB} accepts it anyway.}
    \end{minipage}
\end{frame}
