...
rup x2ge3 x3ge3 ==> 1 ~x1ge4 >= 1 ;
    ...
    \onslide<6->{Now the \texttt{rup} finishes on its own: assume all three literals, and what is
    left reads $0 \ge 1$. Saturating would land exactly on the clause, but a \texttt{pol} only has
    to get close enough for the \texttt{rup}.}
\end{frame}
