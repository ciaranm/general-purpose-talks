...
@x1ge1_up 1 x1b0 1 ~x1ge1 >= 1 ;
@x1ge1_dn 1 ~x1b0 1 x1ge1 >= 1 ;
@x1eq0_up0 1 ~x1eq0 1 ~x1ge1 >= 1 ;
@x1eq0_dn 1 x1eq0 1 x1ge1 >= 1 ;
@x1eq1_up0 1 ~x1eq1 1 x1ge1 >= 1 ;
@x1eq1_dn 1 x1eq1 1 ~x1ge1 >= 1 ;
@x2_ub 2 x2b1 1 x2b0 <= 2 ;
@x2ge1_up 2 x2b1 1 x2b0 1 ~x2ge1 >= 1 ;
@x2ge1_dn 2 ~x2b1 1 ~x2b0 3 x2ge1 >= 3 ;
@x2ge2_up 2 x2b1 1 x2b0 2 ~x2ge2 >= 2 ;
@x2ge2_dn 2 ~x2b1 1 ~x2b0 2 x2ge2 >= 2 ;
@x2eq0_up0 1 ~x2eq0 1 ~x2ge1 >= 1 ;
@x2eq0_dn 1 x2eq0 1 x2ge1 >= 1 ;
@x2eq1_up0 1 ~x2eq1 1 x2ge1 >= 1 ;
@x2eq1_up1 1 ~x2eq1 1 ~x2ge2 >= 1 ;
@x2eq1_dn 1 x2eq1 1 ~x2ge1 1 x2ge2 >= 1 ;
@x2eq2_up0 1 ~x2eq2 1 x2ge2 >= 1 ;
@x2eq2_dn 1 x2eq2 1 ~x2ge2 >= 1 ;
        \end{semiverbatim}
    \end{minipage}\hfill
...
@amo1_0 1 x2eq0 1 x3eq0 <= 1 ;
@amo1_1 1 x2eq1 1 x3eq1 <= 1 ;
@amo1_2 1 x2eq2 1 x3eq2 <= 1 ;
@amo2_0 1 x2eq0 1 x4eq0 <= 1 ;
@amo2_1 1 x2eq1 1 x4eq1 <= 1 ;
@amo2_2 1 x2eq2 1 x4eq2 <= 1 ;
@amo3_0 1 x3eq0 1 x4eq0 <= 1 ;
@amo3_1 1 x3eq1 1 x4eq1 <= 1 ;
@amo3_2 1 x3eq2 1 x4eq2 <= 1 ;
@lin4 1 x1b0 2 x2b1 1 x2b0
      2 x3b1 1 x3b0 2 x4b1 1 x4b0 <= 2 ;
@lin5 -1 x1b0 2 x2b1 1 x2b0
...
\begin{frame}[fragile]{Justifying Linear Inequalities}
    ...
    \begin{Verbatim}[fontsize=\small,commandchars=\\\{\}]
\proofrule{pol} @lin1 @x2ge3_up + @x3ge3_up + @x1ge4_up + ;
...
\begin{frame}[fragile]{The Same Proof, With Nothing Asserted}
    \begin{minipage}[t]{0.58\framewidth}
        \begin{semiverbatim}\scriptsize
pseudo-Boolean proof version 3.0
@atleast2 \proofrule{pol} @x2eq0_dn @x2eq1_dn + @x2eq2_dn + ;
@atleast3 \proofrule{pol} @x3eq0_dn @x3eq1_dn + @x3eq2_dn + ;
@atleast4 \proofrule{pol} @x4eq0_dn @x4eq1_dn + @x4eq2_dn + ;
\proofrule{rup} x1eq0 ==> 1 ~x2ge2 >= 1 ;
\proofrule{rup} x1eq0 ==> 1 ~x3ge2 >= 1 ;
\proofrule{rup} x1eq0 ==> 1 ~x4ge2 >= 1 ;
\proofrule{pol} @amo1_0 @amo1_1 + @atleast2 +
    @atleast3 + @atleast4 + ;
\proofrule{rup} x1eq0 ==> >= 1 ;
\proofrule{rup} ~x1eq0 ==> 1 ~x2ge2 >= 1 ;
\proofrule{rup} ~x1eq0 ==> 1 ~x3ge2 >= 1 ;
...
\begin{frame}[fragile]{\toolname{VeriPB}'s Brand New Experimental Interactive Mode}
    ...
    \begin{Verbatim}[fontsize=\small,commandchars=\\\{\}]
pbp> \proofrule{pol} @lin1 @x2ge3_up + @x3ge3_up + @x1ge4_up + s ;
pbp> :show x1ge4
pbp> :undo
