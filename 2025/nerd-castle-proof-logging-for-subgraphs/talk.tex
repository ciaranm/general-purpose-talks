...
\end{tikzpicture}\end{onlyenv}%
         ...
         \begin{itemize}
             \item Start with some axioms, which we assume are true facts.
             ...
             \item <8-> For maximum clique:
                 \begin{itemize}
                     \item The axioms are the definition of a maximum clique, and the edges in the graph.
