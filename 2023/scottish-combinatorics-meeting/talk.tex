...
\begin{frame}{Constraint Programming}
    \begin{itemize}
        ...
        \item Give each variable a value from its domain, satisfying all constraints.
        \item Solve using intelligent backtracking search.
    \end{itemize}
\end{frame}
...
\begin{frame}{Worst-Case Complexity vs Practice}
    \begin{itemize}
        ...
        \item We have some scientific explanations, but no theoretical ones.
    \end{itemize}
\end{frame}
...
\begin{frame}{Where We're At}
    \begin{itemize}
        ...
        \item <2-> Not being either proof logged or formally verified should be considered socially
            unacceptable.
        \item <3-> Perhaps proof logging can provide some insight into the complete failure of theoretical
            computer science as a scientific theory?
    \end{itemize}
\end{frame}
