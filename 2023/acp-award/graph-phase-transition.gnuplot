...
plot \
    "rcc-150-0-1000-1000-100000-decide-20.mean_sat_nodes" u ($1/1000):($3/100000) w filledcurve x1 axes x1y2 ls 10 ti "Sat?", \
    "rcc-150-0-1000-1000-100000-decide-20.mean_nodes" u ($1/1000):($4) w l ls 1 lw 3 ti "Mean Search"
