...
\begin{frame}{Extremely Critical Point That is Easily Misunderstood}
    \begin{itemize}
        \item We're working with a normal constraint programming solver here.
        \item The Pseudo-Boolean encoding is only for the proof, and does not
            affect how the solver works.
    \end{itemize}
\end{frame}
